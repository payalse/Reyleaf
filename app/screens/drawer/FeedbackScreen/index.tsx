...
const FeedbackScreen = () => {
  ...
  const requestApi = async () => {
    try {
      if (!text) {
        ShowAlert({textBody: 'Please add your feedback!', type: ALERT_TYPE.WARNING});
        return;
      }
      setLoading(true);
      const data = {
        ...
        <TouchableOpacity onPress={() => setEmoji('sad')}>
          <View
            style={{
              ...
              backgroundColor: emoji == 'sad' ? COLORS.greenDark : 'transparent',
              borderWidth: 2,
        ...
        <TouchableOpacity onPress={() => setEmoji('happy')}>
          <View
            style={{
              ...
              backgroundColor: emoji == 'happy' ? COLORS.greenDark : 'transparent',
              borderWidth: 2,
              borderRadius: 50,
        ...
        <TouchableOpacity onPress={() => setEmoji('frustrated')}>
          <View
            style={{
              ...
              backgroundColor: emoji == 'frustrated' ? COLORS.greenDark : 'transparent',
              borderWidth: 2,
