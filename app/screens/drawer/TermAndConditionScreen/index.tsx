  ...
  return (
    <LayoutBG type="bg-tr">
      ...
      <ScrollView
        ...
        <Text style={styles.text}>
          1.2. Account Information: You agree to provide accurate, current, and
          complete information during the registration process and to update
          this information promptly if there are any changes.
        </Text>
        <Text style={styles.text}>
        ...
        <Text style={styles.text}>
          2.1. Compliance with Laws: You agree to use the Service in compliance
          with all applicable laws, regulations, and guidelines, including but
          not limited to those related to privacy, data protection, and
