  ...
  return (
    <LayoutBG type="bg-leaf">
      ...
      >
        ...
        <MyText bold={FONT_WEIGHT.bold} size={FONT_SIZE['3xl']} style={{textAlign: 'center'}}>
          {user?.role == 2 ? 'Business Account has been created Successfully' : 'Your Account Created Successfully'}
        </MyText>
        <MyText
          center
          color={COLORS.grey}
